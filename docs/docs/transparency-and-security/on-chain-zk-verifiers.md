...
You can verify these are the initialized `aggregateVkeyHash`es by inspecting the [logs](https://etherscan.io/tx/#eventlog) of the `AxiomV2Query` contract deployment.
</TabItem>
</Tabs>
